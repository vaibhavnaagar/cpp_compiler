...
def p_nested_id1(p):
	...
	add_children(1,"nested_id")
	pass

def p_nested_id2(p):
	"nested_id : id_scope nested_id"
	add_children(2,"nested_id")
	pass

def p_scoped_id1(p):
	"scoped_id : nested_id"
	add_children(1,"scoped_id")
	pass

def p_scoped_id2(p):
	"scoped_id : global_scope nested_id"
	add_children(2,"scoped_id")
	pass
...
def p_nested_special_function_id1(p):
	...
	add_children(1,"nested_special_function_id")
	pass
...
def p_scoped_special_function_id1(p):
	...
	add_children(1,"scoped_special_function_id")
	pass
...
def p_translation_unit(p):
	...
	add_children(1,"translation_unit")
	pass
...
def p_primary_expression1(p):
	...
	add_children(1,"primary expression")
	pass
...
def p_abstract_expression1(p):
	...
	add_children(1,"abstract_expression")
	pass
...
def p_abstract_expression2(p):
	...
	create_child("None","[")
	create_child("None","]")
	add_children(3,"abstract_expression")
	pass
...
def p_postfix_expression13(p):
	...
	add_children(7,"postfix_expression")
	pass
...
def p_unary_expression5(p):
	...
	add_children(3,"unary_expression")
	pass
...
def p_direct_new_declarator1(p):
	...
	add_children(3,"direct_new_declarator")
	pass
...
def p_direct_new_declarator2(p):
	...
	create_child("None",p[2])
	create_child("None",p[4])
	add_children(4,"direct_new_declarator")
	pass
...
def p_new_initializer_opt2(p):
	...
	create_child("None",p[1])
	create_child("None",p[3])
	add_children(3,"new_initializer_opt")
	pass
...
def p_additive_expression1(p):
	...
	add_children(1,"additive_expression")
	pass

def p_additive_expression2(p):
	"additive_expression : additive_expression '+' multiplicative_expression"
	create_child("None",p[2])
	add_children(3,"additive_expression")
	pass
...
def p_relational_expression1(p):
	...
	add_children(1,"relational_expression")
	pass

def p_relational_expression2(p):
	"relational_expression : relational_expression '<' shift_expression"
	create_child("None",p[2])
	add_children(3,"relational_expression")
	pass
...
def p_equality_expression1(p):
	...
	add_children(1,"equality_expression")
	pass

def p_equality_expression2(p):
	"equality_expression : equality_expression EQ relational_expression"
	create_child("None",p[2])
	add_children(3,"equality_expression")
	pass
...
def p_conditional_expression2(p):
	...
	create_child("None",p[2])
	create_child("None",p[4])
	add_children(5,"conditional_expression")
	pass
...
def p_expression_opt2(p):
	...
	add_children(1,"expression_opt")
	pass

def p_expression1(p):
	"expression : assignment_expression"
	add_children(1,"expression")
	pass

def p_expression2(p):
	"expression : expression_list ',' assignment_expression"
	create_child("None",'COMMA')
	add_children(3,"expression")
	pass

def p_constant_expression(p):
	"constant_expression : conditional_expression"
	add_children(1,"constant_expression")
	pass
...
def p_control_statement1(p):
	...
	add_children(1,"control_statement")
	pass
...
def p_labeled_statement1(p):
	...
	create_child("None",p[2])
	add_children(3,"labeled_statement")
	pass
...
def p_labeled_statement2(p):
	...
	create_child("None",p[1])
	create_child("None",p[3])
	add_children(4,"labeled_statement")
	pass
...
def p_compound_statement1(p):
	...
	create_child("None",p[1])
	create_child("None",p[3])
	add_children(3,"compound_statement")
	pass
...
def p_compound_statement2(p):
	...
	add_children(6,"compund_statement")
	pass
...
def p_statement_seq_opt2(p):
	...
	add_children(2,"statement_seq_opt")
	pass
...
def p_statement_seq_opt3(p):
	...
	create_child("None",p[3])
	create_child("None",p[6])
	add_children(6,"statement_seq_opt")
	pass
...
def p_selection_statement1(p):
	...
	create_child("None",p[2])
	create_child("None",p[4])
	add_children(5,"selection_statement")
	pass
...
def p_selection_statement2(p):
	...
	create_child("None",p[4])
	create_child("None",p[6])
	add_children(7,"selection_statement")
	pass
...
def p_condition_opt2(p):
	...
	add_children(1,"condition_opt")
	pass

def p_condition(p):
	"condition : parameter_declaration_list"
	add_children(1,"condition")
	pass
...
def p_iteration_statement1(p):
	...
	#create_child("None",p[2])
	#create_child("None",p[4])
	add_children(5,"iteration_statement")
	pass
...
def p_iteration_statement2(p):
	...
	create_child("None",p[5])
	create_child("None",p[6])
	add_children(6,"iteration_statement")
	pass
...
def p_iteration_statement3(p):
	...
	create_child("None",p[5])
	create_child("None",p[7])
	add_children(8,"iteration_statement")
	pass

def p_for_init_statement(p):
	"for_init_statement : simple_declaration"
	add_children(1,"for_init_statement")
	pass
...
def p_declaration_statement(p):
	...
	add_children(1,"declaration_statement")
	pass
...
def p_compound_declaration1(p):
	...
	create_child("None",p[1])
	create_child("None",p[3])
	add_children(3,"compound_declaration")
	pass
...
def p_compound_declaration2(p):
	...
	add_children(8,"compound_declaration")
	pass
...
def p_declaration_seq_opt2(p):
	...
	add_children(3,"declaration_seq_opt")
	pass
...
def p_specialised_declaration1(p):
	...
	add_children(1,"specialised_declaration")
	pass
...
def p_block_declaration1(p):
	...
	add_children(1,"block_declaration")
	pass
...
def p_specialised_block_declaration1(p):
	...
	add_children(1,"specialised_block_declaration")
	pass
...
def p_simple_declaration1(p):
	"simple_declaration : ';'"
	create_child("None",p[1])
	add_children(2,"simple_declaration")
	pass
...
def p_suffix_built_in_decl_specifier_raw1(p):
	...
	add_children(1,"suffix_built_in_decl_specifier_raw ")
	pass
...
def p_suffix_built_in_decl_specifier1(p):
	...
	add_children(1,"suffix_built_in_decl_specifier ")
	pass


def p_suffix_named_decl_specifier1(p):
	"suffix_named_decl_specifier : scoped_id"
	add_children(1,"suffix_named_decl_specifier")
	pass
...
def p_suffix_decl_specified_ids2(p):
	...
	add_children(2,"suffix_decl_specified_ids")
	pass
...
def p_suffix_decl_specified_scope1(p):
	...
	create_child("None",p[2])
	add_children(2,"suffix_decl_specified_scope")
	pass
...
def p_suffix_decl_specified_scope2(p):
	...
	create_child("None",p[3])
	add_children(3,"suffix_decl_specified_scope")
	pass
...
def p_decl_specifier_affix1(p):
	...
	add_children(1,"decl_specifier_affix")
	pass
...
def p_decl_specifier_suffix(p):
	...
	add_children(1,"decl_specifier_suffix")
	pass

def p_decl_specifier_prefix1(p):
	"decl_specifier_prefix : decl_specifier_affix"
	add_children(1,"decl_specifier_prefix")
	pass
...
def p_storage_class_specifier1(p):
	'''storage_class_specifier : REGISTER
							   ...
							   | MUTABLE'''
	create_child("None",p[1])
	add_children(1,"storage_class_specifier")
	pass
...
def p_function_specifier1(p):
	...
	create_child("None",p[1])
	add_children(1,"function_specifier")
	pass
...
def p_elaborate_type_specifier1(p):
	...
	add_children(1,"elaborate_type_specifier")
	pass
...
def p_simple_type_specifier1(p):
	...
	add_children(1,"simple_type_specifier")
	pass
...
def p_elaborated_type_specifier1(p):
	...
	add_children(1,"elaborated_type_specifier")
	pass
...
def p_elaborated_type_specifier3(p):
	...
	create_child("None",p[1])
	add_children(2,"elaborated_type_specifier")
	pass
...
def p_namespace_alias_definition(p):
	...
	create_child("None",p[3])
	create_child("None",p[5])
	add_children(5,"namespace_alias_definition")
	pass
...
def p_using_declaration1(p):
	...
	create_child("None",p[1])
	create_child("None",p[3])
	add_children(3,"using_declaration")
	pass
...
def p_using_declaration2(p):
	...
	create_child("None",p[2])
	create_child("None",p[4])
	add_children(4,"using_declaration")
	pass
...
def p_using_directive(p):
	...
	create_child("None",p[2])
	create_child("None",p[4])
	add_children(4,"using_directive")
	pass
...
def p_init_declarations1(p):
	...
	create_child("None",'COMMA')
	add_children(3,"init_declarations")
	pass
...
def p_init_declaration(p):
	...
	add_children(1,"init_declaration")
	pass
...
def p_ptr_operator_seq_opt2(p):
	...
	add_children(2,"ptr_operator_seq_opt")
	pass
...
def p_cv_qualifier_seq_opt2(p):
	...
	add_children(2,"cv_qualifier_seq_opt")
	pass
...
def p_direct_abstract_declarator2(p):
	...
	create_child("None",p[2])
	create_child("None",p[3])
	add_children(3,"direct_abstract_declarator")
	pass
...
def p_parameters_clause(p):
	...
	create_child("None",p[1])
	create_child("None",p[3])
	add_children(3,"paremeters_clause")
	pass
...
def p_parameter_declaration1(p):
	...
	add_children(1,"parameter_declaration")
	pass
...
def p_parameter_declaration3(p):
	...
	add_children(2,"parameter_declaration")
	pass
...
def p_function_definition1(p):
	...
	add_children(1,"function_definition")
	pass
...
def p_func_definition1(p):
	...
	add_children(2,"func_definition")
	pass
...
def p_ctor_definition1(p):
	...
	add_children(2,"ctor_definition")
	pass
...
def p_initializer_clause1(p):
	...
	add_children(1,"initializer_clause")
	pass
...
def p_braced_initializer1(p):
	...
	create_child("None",p[1])
	create_child("None",p[3])
	add_children(3,"braced_initializer")
	pass
...
def p_braced_initializer2(p):
	...
	create_child("None",'COMMA')
	create_child("None",p[4])
	add_children(4,"braced_initializer")
	pass
...
def p_braced_initializer3(p):
	...
	create_child("None",p[1])
	create_child("None",p[2])
	add_children(2,"braced_initializer")
	pass
...
def p_braced_initializer4(p):
	...
	create_child("None",p[3])
	create_child("None",p[6])
	add_children(6,"braced_initializer")
	pass
...
def p_class_specifier1(p):
	...
	create_child("None",p[3])
	add_children(3,"class_specifier")
	pass
...
def p_class_specifier2(p):
	...
	create_child("None",p[4])
	create_child("None",p[7])
	add_children(7,"class_specifier")
	pass
...
def p_member_specification_opt2(p):
	...
	add_children(3,"member_specification_opt")
	pass
...
def p_simple_member_declaration2(p):
	...
	create_child("None",p[2])
	add_children(2,"simple_member_declaration")
	pass
...
def p_member_init_declarations1(p):
	...
	create_child("None",'COMMA')
	add_children(3,"member_init_declarations")
	pass
...
def p_base_specifier_list1(p):
	...
	add_children(1,"base_specifier_list")
	pass
...
def p_mem_initializer(p):
	...
	create_child("None",p[2])
	create_child("None",p[4])
	add_children(4,"mem_initializer")
	pass

def p_mem_initializer_id(p):
	"mem_initializer_id : scoped_id"
	add_children(1,"mem_initializer_id")
	pass
...
def p_operator_function_id(p):
	...
	create_child("None",p[1])
	add_children(4,"operator_function_id")
	pass
...
def p_try_block(p):
	...
	create_child("None",p[1])
	add_children(3,"try_block")
	pass

def p_handler_seq1(p):
	"handler_seq : handler"
	add_children(1,"handler_seq")
	pass

def p_handler_seq2(p):
	"handler_seq : handler handler_seq"
	add_children(2,"handler_seq")
	pass
...
def p_throw_expression2(p):
	...
	create_child("None",p[1])
	add_children(2,"throw_expression")
	pass
...
def p_exception_specification1(p):
	...
	create_child("None",p[2])
	create_child("None",p[3])
	add_children(3,"exception_specification")
	pass
...
def p_exception_specification2(p):
	...
	create_child("None",p[2])
	create_child("None",p[4])
	add_children(4,"exception_specification")
	pass

def p_type_id_list1(p):
	"type_id_list : type_id"
	add_children(1,"type_id_list")
	pass

def p_type_id_list2(p):
	"type_id_list : type_id_list ',' type_id"
	create_child("None","COMMA")
	add_children(3,"type_id_list")
	pass
